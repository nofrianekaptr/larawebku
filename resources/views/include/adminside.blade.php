              ...
              <ul class="menu">
                  ...
                  <li class="sidebar-item  ">
                      <a href="{{ route('dashboard') }}" class='sidebar-link '>
                          ...
                          <span
                              class="{{ request()->routeis('dashboard') ? 'fw-bold text-primary' : '' }}">Dashboard</span>
                      </a>
                  </li>


                  <li class="sidebar-title text-uppercase fw-bold ">master menu</li>
                  ...
                  <li class="sidebar-item  ">
                      <a href="{{ route('shorturl.index') }}" class='sidebar-link '>
                          <i data-feather="link"></i>
                          <span>Short Url</span>
                      </a>
                  </li>

                  <li class="sidebar-title text-uppercase fw-bold ">menu lainnya</li>


                  <li class="sidebar-item  ">
                      <a href="{{ route('setting.profile') }}" class='sidebar-link '>
                  ...
                  <li class="sidebar-item  ">
                      <a href="{{ route('setting.password') }}" class='sidebar-link '>
